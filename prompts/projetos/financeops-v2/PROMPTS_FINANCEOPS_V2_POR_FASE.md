...
Esta sequencia adapta `prompts/base-generica/PROMPT_DEFINICAO_PROJETO.md` e `prompts/base-generica/PROMPTS_FASEADOS_BASE.md` especificamente para o `financeops-v2`.

Ela existe para evitar recriacao one-shot e para conduzir o projeto como validacao real da base atual.

## Ordem de uso

1. usar `prompts/projetos/financeops-v2/PROMPT_FINANCEOPS_V2_CANONICO.md` para a Fase 1
...
- `prompts/projetos/financeops-v2/PROMPT_FINANCEOPS_V2_CANONICO.md`
