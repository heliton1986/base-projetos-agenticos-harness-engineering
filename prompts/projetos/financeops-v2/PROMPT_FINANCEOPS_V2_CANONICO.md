...
Prompt pronto para iniciar o `financeops-v2` com `prompts/base-generica/PROMPT_DEFINICAO_PROJETO.md`, ja alinhado com:
...
- `prompts/projetos/financeops-v2/PROMPTS_FINANCEOPS_V2_POR_FASE.md`
