...
- `[HARNESS_BASE_PATH]/01_FRAMEWORK_PRATICO_HARNESS_AGENTIC_SYSTEMS.md`
- `[HARNESS_BASE_PATH]/02_DOE_OPERACIONAL_PARA_HARNESS.md`
- `[HARNESS_BASE_PATH]/03_BOOTSTRAP_PROJETO_AGENTICO.md`
- `[HARNESS_BASE_PATH]/04_CHECKLIST_PARA_GERAR_AGENTS_MD.md`
- `[HARNESS_BASE_PATH]/05_KB_MINIMA_PARA_PROJETOS_AGENTICOS.md`
- `[HARNESS_BASE_PATH]/06_PADRAO_BUILDER_VALIDATOR_E_TASK_CONTRACTS.md`
...
- `[HARNESS_BASE_PATH]/07_FRONTEND_OBSERVAVEL_PARA_AGENTES.md`

Como apoio complementar, quando precisar de camada opcional de examples, references ou visuals:

- `[HARNESS_BASE_PATH]/08_ESTRUTURA_OPCIONAL_KB_REFERENCES_VISUALS_EXAMPLES.md`
