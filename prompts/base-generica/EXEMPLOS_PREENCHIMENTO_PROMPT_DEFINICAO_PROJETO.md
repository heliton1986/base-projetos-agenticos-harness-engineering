...
Este documento traz exemplos prontos de preenchimento do `prompts/base-generica/PROMPT_DEFINICAO_PROJETO.md` para diferentes tipos de projeto agentico.
...
Ref. pronta para uso: `prompts/projetos/financeops-v2/PROMPT_FINANCEOPS_V2_CANONICO.md`
